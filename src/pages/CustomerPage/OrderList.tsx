...
const UserOrdersPage: React.FC = () => {
    ...
    return (
        <div className="bg-[#F5F5FA] p-5 pl-15 pr-15 flex">
            <SidebarProfile />
            <div className="w-4/5 rounded-xl bg-gray-800 p-6 shadow-md min-h-150">
                <h2 className="text-xl font-semibold mb-4 text-white">Đơn hàng của bạn</h2>
                {orders.length > 0 ? (
                    <div className="overflow-x-auto">
                        <table className="min-w-full border-collapse shadow-lg rounded-lg bg-gray-300 overflow-hidden">
