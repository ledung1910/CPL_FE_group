...
export default function OrderDetail() {
  ...
  if (order.status === "cancelled" && deliveryDate) {
    ...
    deliveryText = `Giao ${format(deliveryDate, "EEEE, 'trước' HH'h', dd/MM", {
      locale: vi,
    })}`;
  }
    ...
    <div className="bg-[#F5F5FA] p-5 md:pl-15 md:pr-15 flex flex-col md:flex-row gap-4">
      ...
      <div className="w-full md:w-4/5 rounded-xl mt-3 md:mt-12">
        <div className="flex justify-between items-start pb-4">
          <h2 className="text-xl mb-1 text-gray-700">
        ...
        <p className="text-sm text-black text-right mb-4 w-full">
                    ...
                    <tr key={item.book_id} className="bg-white border-b border-gray-200">
                      <td className="p-3 flex items-start min-w-[250px]">
                        ...
                        <div>
                          ...
                          <img src="/images/doitra.png" alt="30NgayDoiTra" className="mt-3 h-6"
                          />
