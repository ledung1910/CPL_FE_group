...
export default function Checkout() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const finalTotalAmount = orderItems.reduce(
      ...
      <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="relative bg-sky-50 border border-sky-200 rounded-lg p-4 mb-12">
              <div className="space-y-3">
                <label className="flex items-center cursor-pointer group">
                  ...
                  <span className="bg-green-100 text-green-700 font-semibold text-xs px-2 py-0.5 rounded">
                    -{shippingDiscount.toLocaleString("vi-VN")}K
                  </span>
                </label>
                <label className="flex items-center cursor-pointer group">
                  <input
                ...
                <div className="flex justify-between items-center mb-3 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      ...
                      title={`Được giảm ${shippingDiscount.toLocaleString(
                        "vi-VN"
                      )}đ phí vận chuyển`}
                    >
                      ⓘ
                        ...
                        >
                          ...
                          <div className="flex flex-col items-end min-w-[100px] text-right">
                            ...
                            <p className="text-red-600 text-sm font-medium">
                              {item.book.current_seller?.price?.toLocaleString(
                                "vi-VN"
                              )}{" "}
                              ₫
                            </p>
        ...
        <div className="w-full lg:w-1/4 space-y-4">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <div className="border border-blue-500 bg-blue-50 rounded-lg p-3 flex items-center justify-between mb-2 text-sm">
              <div className="flex items-center gap-2">
                <img
                  src="https://salt.tikicdn.com/cache/128x128/ts/upload/35/5a/84/aeb7211d441194fc09cd1baf3c1930e4.jpg"
                  alt="FreeShip"
                  className="w-8 h-8"
                />
                <span className="text-blue-700 font-medium">
                  Giảm {shippingDiscount.toLocaleString("vi-VN")}K Vận chuyển
                </span>
              </div>
              <button className="text-blue-600 border border-blue-500 rounded px-3 py-1 text-xs font-medium hover:bg-blue-100">
                Bỏ chọn
              </button>
            </div>
            <button className="text-blue-600 hover:text-blue-700 flex items-center gap-1.5 mt-2 text-sm">
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="space-y-1.5 text-sm px-4 py-2">
              <div className="flex justify-between text-gray-700">
                <span>Tạm tính</span>
                <span>{totalItemPrice.toLocaleString("vi-VN")} ₫</span>
              </div>
              <div className="flex justify-between text-gray-700">
